...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<select 	name="category"		class="ct_input_g" 
				...
				<c:if test="${ product.category == '2' }">
					<option value="1">식음료품</option>
					<option value="2" selected="selected">가전제품</option>
					<option value="3">취미생활</option>
					<option value="4">운동기구</option>
				</c:if>
				<c:if test="${ product.category == '3' }">
					<option value="1">식음료품</option>
					<option value="2">가전제품</option>
					<option value="3" selected="selected">취미생활</option>
					<option value="4">운동기구</option>
				</c:if>
				<c:if test="${ product.category == '4' }">
					...
					<option value="2">가전제품</option>
					<option value="3">취미생활</option>
					<option value="4" selected="selected">운동기구</option>
				</c:if>
